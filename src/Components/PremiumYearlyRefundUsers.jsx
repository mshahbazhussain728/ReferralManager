...
// export default function YearlyRefundUsers() {
//   const navigate = useNavigate();
//   const location = useLocation();
//   const [userSearchTerm, setUserSearchTerm] = useState("");
//   const [tableSearchTerm, setTableSearchTerm] = useState("");
...
export default function YearlyRefundUsers() {
  ...
  useEffect(() => {
    if (location.state?.selectedUserId) {
      sessionStorage.setItem("yearlyRefundUser", JSON.stringify(location.state));
    }
  }, [location.state]);
  ...
  const savedUser = (() => {
    try {
      const raw = sessionStorage.getItem("yearlyRefundUser");
