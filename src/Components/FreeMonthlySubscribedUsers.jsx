...
// //   const uniqueEarnings = [...new Set(leftUsers.map(u => u.earning))].sort((a, b) => b - a);
...
// //       <span key={i} style={{ color: i < rating ? "#691188" : "#d1d5db" }}>
// //         ★
// //       </span>
// //     ));
// //   };
...
// //   const filteredLeftUsers = leftUsers
// //     .filter(user => user.name.toLowerCase().includes(userSearchTerm.toLowerCase()))
// //     .sort((a, b) => {
// //       // Sort by stars (highest to lowest), then by earning within same star rating
// //       const starsA = calculateStars(a.earning);
// //       const starsB = calculateStars(b.earning);
      
// //       if (starsB !== starsA) {
// //         return starsB - starsA; // Sort by stars descending
// //       }
// //       return b.earning - a.earning; // If same stars, sort by earning descending
// //     });

// //   // Filter table data from selected user
// //   const currentUser = filteredLeftUsers.length > 0 ? filteredLeftUsers[selectedUserIndex] : leftUsers[0];
// //   const filteredTableData = currentUser.tableData.filter(user =>
// //     user.name.toLowerCase().includes(tableSearchTerm.toLowerCase())
// //   );

// //   // Calculate stats
// //   const totalUsers = filteredTableData.length;
  
// //   // This month users (January 2025)
// //   const thisMonthUsers = filteredTableData.filter(user => {
// //     const dateStr = user.date;
// //     return dateStr.includes("Jan") && dateStr.includes("2025");
// //   }).length;

// //   // This week users (last 7 days - Jan 14-20, 2025)
// //   const thisWeekUsers = filteredTableData.filter(user => {
// //     const dateStr = user.date;
// //     return (dateStr.includes("Jan 14 2025") || 
// //             dateStr.includes("Jan 15 2025") ||
// //             dateStr.includes("Jan 16 2025") ||
// //             dateStr.includes("Jan 17 2025") ||
// //             dateStr.includes("Jan 18 2025") ||
// //             dateStr.includes("Jan 19 2025") ||
// //             dateStr.includes("Jan 20 2025"));
// //   }).length;

// //   // Revenue - use current user's balance
// //   const totalRevenue = currentUser.balance;

// //   // Calculate counts for Sidebar
// //   const totalFreeUsers = filteredLeftUsers.length;
...
// //                   setTableSearchTerm("");
// //                 }}
// //                 className={`flex flex-col p-2 mt-3 rounded-md cursor-pointer transition-colors ${
// //                   selectedUserIndex === index ? "bg-[#E8F0F6] border border-[#055860]" : "hover:bg-[#F5F6FA]"
// //                 }`}
// //               >
...
//   // Filter + sort by earning descending
//   const filteredLeftUsers = leftUsers
//     .filter(user => user.name.toLowerCase().includes(userSearchTerm.toLowerCase()))
...
//               <div
//                 key={index}
//                 onClick={() => { setSelectedUserIndex(index); setCurrentPage(1); setTableSearchTerm(""); }}
//                 className={`flex flex-col p-2 mt-3 rounded-md cursor-pointer transition-colors ${
//                   selectedUserIndex === index ? "bg-[#E8F0F6] border border-[#055860]" : "hover:bg-[#F5F6FA]"
//                 }`}
//               >
