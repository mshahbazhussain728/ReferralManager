...
// // // // ── ALL 22 marketing agents with their monthly-cancelled table data ────────────
...
// // //       { name: "Kevin Hart",    date: "Jan 10 2025", time: "09:00 AM", image: "https://randomuser.me/api/portraits/men/29.jpg"   },
// // //       { name: "Sophie Turner", date: "Jan 15 2025", time: "01:45 PM", image: "https://randomuser.me/api/portraits/women/29.jpg" },
// // //     ],
// // //   },
// // //   {
// // //     name: "Sohan",
...
// // //       { name: "Harry Styles",  date: "Jan 12 2025", time: "10:30 AM", image: "https://randomuser.me/api/portraits/men/31.jpg"   },
// // //     ],
// // //   },
// // //   {
// // //     name: "Eduardo",
...
// // //       { name: "Oscar Wilde",   date: "Jan 08 2025", time: "08:45 AM", image: "https://randomuser.me/api/portraits/men/32.jpg"   },
// // //       { name: "Fiona Green",   date: "Jan 15 2025", time: "12:30 PM", image: "https://randomuser.me/api/portraits/women/32.jpg" },
// // //     ],
// // //   },
// // //   {
// // //     name: "Colleen",
...
// // //       { name: "Arnold Shaw",     date: "Jan 11 2025", time: "07:50 AM", image: "https://randomuser.me/api/portraits/men/34.jpg"   },
// // //     ],
// // //   },
// // //   {
// // //     name: "Shane",
...
// // //       { name: "Tyler Durden",       date: "Jan 13 2025", time: "04:10 PM", image: "https://randomuser.me/api/portraits/men/44.jpg"   },
// // //       { name: "Anna Karenina",      date: "Jan 16 2025", time: "09:35 AM", image: "https://randomuser.me/api/portraits/women/44.jpg" },
// // //     ],
// // //   },
// // //   {
// // //     name: "Darrell",
...
// // //       { name: "Peter Parker",  date: "Jan 09 2025", time: "03:00 PM", image: "https://randomuser.me/api/portraits/men/46.jpg"   },
// // //     ],
// // //   },
// // //   {
// // //     name: "Marvin",
...
// // //       { name: "Sandra Bullock",  date: "Jan 07 2025", time: "01:10 PM", image: "https://randomuser.me/api/portraits/women/46.jpg" },
// // //       { name: "Tom Hanks",       date: "Jan 14 2025", time: "06:40 AM", image: "https://randomuser.me/api/portraits/men/47.jpg"   },
// // //     ],
// // //   },
// // //   {
// // //     name: "Jessica",
...
// // //       { name: "Victor Stone",   date: "Jan 06 2025", time: "11:55 AM", image: "https://randomuser.me/api/portraits/men/48.jpg"   },
// // //       { name: "Wanda Maximoff", date: "Jan 15 2025", time: "03:30 PM", image: "https://randomuser.me/api/portraits/women/48.jpg" },
// // //     ],
// // //   },
// // //   {
// // //     name: "Marcus Brown",
...
// // //       { name: "Chloe Adams",    date: "Jan 14 2025", time: "09:15 AM", image: "https://randomuser.me/api/portraits/women/49.jpg" },
// // //     ],
// // //   },
// // //   {
// // //     name: "Jessica Davis",
...
// // //       { name: "Evan Morris",   date: "Jan 16 2025", time: "11:00 AM", image: "https://randomuser.me/api/portraits/men/51.jpg"   },
// // //       { name: "Faith Turner",  date: "Jan 19 2025", time: "04:30 PM", image: "https://randomuser.me/api/portraits/women/50.jpg" },
// // //     ],
// // //   },
// // //   {
// // //     name: "Test User",
...
// // //       { name: "Isaac Newton",    date: "Jan 19 2025", time: "06:30 AM", image: "https://randomuser.me/api/portraits/men/53.jpg"   },
// // //       { name: "Julia Roberts",   date: "Jan 16 2025", time: "02:15 PM", image: "https://randomuser.me/api/portraits/women/51.jpg" },
// // //     ],
// // //   },
// // //   {
// // //     name: "Natalie Wilson",
...
// // //       { name: "Liam Neeson",   date: "Jan 15 2025", time: "08:10 AM", image: "https://randomuser.me/api/portraits/men/55.jpg"   },
// // //     ],
// // //   },
// // //   {
// // //     name: "Kevin Anderson",
...
// // //       { name: "Noah Bennett",  date: "Jan 14 2025", time: "07:20 AM", image: "https://randomuser.me/api/portraits/men/56.jpg"   },
// // //       { name: "Olivia Pope",   date: "Jan 17 2025", time: "12:55 PM", image: "https://randomuser.me/api/portraits/women/53.jpg" },
// // //     ],
// // //   },
// // //   {
// // //     name: "Samantha Lee",
...
// // //       { name: "Quinn James",   date: "Jan 15 2025", time: "10:05 AM", image: "https://randomuser.me/api/portraits/men/58.jpg"   },
// // //     ],
// // //   },
// // //   {
// // //     name: "Daniel Carter",
...
// // // export default function MonthlyCancelledUsers() {
...
// //   // ✅ Parse to NUMBER immediately — API requires numeric uid
// //   const rawId =
// //     location.state?.selectedUserId ||
// //     localStorage.getItem("selectedUserId");

// //   const selectedUserId = rawId ? Number(rawId) : null;
...
// //   // ✅ Persist to localStorage — always overwrite with latest from navigation
// //   useEffect(() => {
// //     if (location.state?.selectedUserId)      localStorage.setItem("selectedUserId",      String(location.state.selectedUserId));
...
// //     if (location.state?.selectedUserBalance) localStorage.setItem("selectedUserBalance", String(location.state.selectedUserBalance));
...
// //       if (json.success && json.data?.monthlyCanceledUsers) {
// //         const m = json.data.monthlyCanceledUsers;
// //         setStats({
...
// //       console.warn("⛔ Invalid selectedUserId:", selectedUserId);
// //       return;
// //     }

// //     console.log("✅ Fetching for uid:", selectedUserId, "type:", typeof selectedUserId);
...
// //         headers: { "Content-Type": "application/json" },
// //         body: JSON.stringify({
// //           uid:    selectedUserId,   // ✅ already a Number
// //           type:   "monthly",
// //           status: "canceled",
// //           sort:   "subscribedDate",
// //           size:   itemsPerPage,
...
// //       });
// //       const json = await res.json();
// //       console.log("API 2 response:", json);
...
// //       <div className="h-[115px] w-[160px] bg-[#055860] text-white text-center flex items-center justify-center" style={{ borderRight: "0.5px solid white" }}>
// //         <div className="text-md font-semibold leading-[200%]">
// //           <span className="block whitespace-nowrap">Monthly</span>
// //           <span className="block whitespace-nowrap">Cancelled Users</span>
// //         </div>
...
// //   const fetchStats = useCallback(async () => {
// //     if (!selectedUserId || isNaN(selectedUserId) || selectedUserId <= 0) return;
// //     setStatsLoading(true);
// //     try {
...
// //       if (json.success && json.metrics) {
// //         setStats({
// //           thisMonth: json.statistics?.thisMonth ?? 0,
// //           thisWeek:  json.statistics?.thisWeek  ?? 0,
// //           revenue:   json.metrics?.revenue      ?? 0,
// //         });
// //       }
// //     } catch (err) {
// //       console.error("fetchStats error:", err);
...
// //   useEffect(() => { if (selectedUserId) { fetchStats(); fetchTableData(1); } }, [selectedUserId]);
// //   useEffect(() => { setCurrentPage(1); }, [tableSearchTerm]);
...
// //   // ── User identity — only from location.state or localStorage (no fake fallbacks) ──
// //   const rawId      = location.state?.selectedUserId || localStorage.getItem("selectedUserId");
// //   const selectedUserId = rawId ? Number(rawId) : null;
...
// //       const json = await res.json();
// //       if (json.success && json.data?.monthlyCanceledUsers) {
// //         const d = json.data.monthlyCanceledUsers;
// //         setStats({
// //           total:     d.total     ?? 0,
...
// //   // ── Left panel search filters the real API user ───────────────────────────
// //   const showLeftUser =
// //     !!selectedUserName &&
...
// //   // ── Avatar helper — no fake fallback, only real avatar or initial-based ───
...
// //                   const sub        = row.Subscriptions?.[0];
// //                   const userName   = row.name || "Unknown";
// //                   const userAvatar = resolveAvatar(row.image || row.imageUrl, userName);
// //                   return (
// //                     <tr key={row.id || index} className="border-b">
// //                       <td className="p-4">
// //                         <div className="flex items-center gap-2">
...
//   const selectedUserId     = location.state?.selectedUserId ? Number(location.state.selectedUserId) : null;
...
//                 <span className="text-gray-500">Users: <span className="text-[#055860]">{totalRecords}</span></span>
//                 {/* <span className="text-gray-500">Balance: <span className="text-[#055860]">${parseFloat(selectedUserBalance).toLocaleString()}</span></span> */}
//                 <span className="text-gray-500">Revenue: <span className="text-[#055860]">${statsLoading ? "..." : stats.revenue.toLocaleString()}</span></span>
//               </div>
//             </div>
//           ) : (
//             <div className="flex items-center justify-center h-full text-gray-500 text-sm">No users found</div>
...
//   const selectedUserAvatar  = location.state?.selectedUserAvatar  || "";
//   const selectedUserCountry = location.state?.selectedUserCountry || "";
//   const selectedUserBalance = location.state?.selectedUserBalance ?? 0;  // ✅ pulled from location.state
...
// {/* <span className="text-gray-500">Balance: <span className="text-[#055860]">{statsLoading ? "..." : `$${stats.revenue.toLocaleString()}`}</span></span> */}
...
export default function MonthlyCancelledUsers() {
  ...
  useEffect(() => {
    if (location.state?.selectedUserId) {
      sessionStorage.setItem("monthlyCancelledUsersState", JSON.stringify(location.state));
    }
  }, [location.state]);
  ...
  const savedState = location.state?.selectedUserId
    ...
    : (() => {
        try {
          const s = sessionStorage.getItem("monthlyCancelledUsersState");
          return s ? JSON.parse(s) : {};
        } catch { return {}; }
      })();

  const selectedUserId      = savedState.selectedUserId ? Number(savedState.selectedUserId) : null;
